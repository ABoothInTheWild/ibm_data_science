...
> Data science is not only about collecting and storing data—it is about **understanding** it, **cleaning** it, **modeling** it, and **evaluating** it. This module gives you the full pipeline: **data wrangling**, **exploratory data analysis**, **model development**, and **model evaluation and refinement** so you can make predictions and decisions from real datasets.
...
* **5.05 — Exploratory Data Analysis**
...
* **5.08 — Model Evaluation and Refinement**
...
* **5.11 — Live Session** — Placeholder for live session materials (e.g. `.gitkeep`).
...
## The Data Scientist’s Analysis and Modeling Toolkit
